...
A suite of low level tools for working with PNG files in JavaScript, including encoding, decoding, and various utilities that allow for some specific use cases around performance, print resolution, color profile embedding, streaming, and other tasks.

![anim](https://github.com/mattdesl/png-tools/assets/1383811/fa5f62c2-01e8-4df5-84ee-ea9cc5e9ea04)
